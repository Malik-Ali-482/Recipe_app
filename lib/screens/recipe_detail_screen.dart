            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // list of ingredients
                  SizedBox(
                    height: 200, // Set a fixed height for the scrolling area
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              // ingredients images
                              Column(
                                children: widget.documentSnapshot['ingredients_image']
                                    .map<Widget>(
                                      (imageUrl) => Container(
                                    height: 60,
                                    width: 60,
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: widget.documentSnapshot['ingredients_name']
                                    .map<Widget>(
                                      (ingredient) => SizedBox(
                                    height: 60,
                                    child: Center(
                              ...
                              Column(
                                children: List.generate(
                                  widget.documentSnapshot['ingredients_amount'].length,
                                      (index) {
                                    String amount = quantityProvider.updateIngredientAmounts[index];
                                    String type = widget.documentSnapshot['ingredients_type'][index];
                                    return SizedBox(
                                      height: 60,
                                      child: Center(
                                        child: Text(
                                          "$amount $type", // Display the amount with the corresponding unit
                                          style: TextStyle(
                                            fontSize: 16,
                                            color: Colors.grey.shade400,
                                          ),
